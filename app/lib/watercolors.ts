...
export const watercolors: Watercolor[] = [
  { 
    ...
    additionalInfo: 'Esta pieza explora la relación entre espacios construidos y naturaleza.'
  },
  { 
    id: 2, 
    filename: 'watercolor-002.jpg', 
    title: 'Luz y Sombra', 
